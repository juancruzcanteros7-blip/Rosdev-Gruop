...
export default function CTA() {
    ...
    return (
        <section id="contact" className="relative isolate mt-24 mb-20 scroll-m-24 px-6 sm:mt-32 sm:mb-24 lg:px-8">
            ...
            <Reveal width="100%">
                <div className="mx-auto max-w-4xl rounded-3xl border border-gray-100 bg-white/90 px-8 py-10 text-center shadow-xl shadow-indigo-50/50 backdrop-blur sm:px-10 sm:py-12 transition-transform hover:scale-[1.01]">
                    <h2 className="text-3xl font-semibold tracking-tight text-gradient-rosdev sm:text-4xl">{t.title}</h2>
                    <p className="mt-4 text-base text-gray-700 sm:text-lg">{t.description}</p>
                    <div className="mt-8 flex flex-wrap justify-center gap-3 sm:gap-4">
                        ...
                        <Link
                            to="/contact"
                            className="inline-flex items-center gap-2 rounded-lg border border-[#4F46E5] px-4 py-3 text-sm font-semibold text-[#4F46E5] transition hover:bg-[#4F46E5]/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4F46E5]"
                        >
