...
export default function CTA() {
    ...
    return (
        <section id="contact" className="relative isolate mt-24 mb-20 scroll-m-24 px-6 sm:mt-32 sm:mb-24 lg:px-8">
            ...
            <div className="mx-auto max-w-4xl rounded-3xl border border-gray-100 bg-white/90 px-8 py-10 text-center shadow-xl shadow-indigo-50/50 backdrop-blur sm:px-10 sm:py-12">
