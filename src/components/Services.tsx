            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <Reveal width="100%">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mt-3 text-3xl font-semibold text-[#2E2E2E] sm:text-4xl dark:text-white">
                            {t.headline}
                        </p>
                        {t.description ? (
                ...
                <StaggerContainer className="mx-auto mt-14 grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3">
                    {t.items.map((service) => (
                        <StaggerItem key={service.name}>
                            <article className="flex h-full flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm shadow-gray-100 transition-all hover:-translate-y-2 hover:scale-[1.02] hover:shadow-lg hover:shadow-purple-100 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none dark:hover:shadow-purple-900/20">
