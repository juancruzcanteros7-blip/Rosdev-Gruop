            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <StaggerContainer className="mx-auto mt-14 grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3">
                    {t.items.map((service) => (
                        <StaggerItem key={service.name}>
                            <article
                                className="flex h-full flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm shadow-gray-100 transition-all hover:-translate-y-2 hover:scale-[1.02] hover:shadow-lg hover:shadow-purple-100"
                            >
                ...
                <Reveal delay={0.6} width="100%">
                    <div className="mt-12 flex justify-center">
                        <div className="inline-flex items-center gap-3 rounded-full border border-[#4F46E5]/30 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition-transform hover:scale-105">
